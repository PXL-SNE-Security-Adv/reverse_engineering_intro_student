...
- Linker = crew that connects the walls, installs wiring (resolves symbols)
...
The .shstrtab section is where section names are stored. Each sh_name in the section header is an offset into this string table.
